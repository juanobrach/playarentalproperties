    ...
    <div class="sub_footer">  
        <div class="sub_footer_content <?php print $wide_footer_class;?>">
            <span class="copyright">
                <?php      
                echo 'Copyright &copy; '. date('Y') .' Playa Rental Properties. All rights Reserved. Developed by <a href="https://webdesignplaya.com" target="_blank">Web Design Playa del Carmen</a>';
                ?>
            </span>
