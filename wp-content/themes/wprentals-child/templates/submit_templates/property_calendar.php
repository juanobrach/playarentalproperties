    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<label for="renter_name"><?php  esc_html_e('Renter Name','wpestate');?></label>
                <input type="text" id="renter_name" size="40" name="renter_name" class="form-control" value="">
				
				<label for="renter_email"><?php  esc_html_e('Renter Email','wpestate');?></label>
                <input type="text" id="renter_email" size="40" name="renter_email" class="form-control" value="">
				
				<label for="total_value"><?php  esc_html_e('Total Value','wpestate');?></label>
                <input type="text" id="total_value" size="40" name="total_value" class="form-control" value="">
				
				<label for="amount_paid"><?php  esc_html_e('Amount Paid','wpestate');?></label>
                <input type="text" id="amount_paid" size="40" name="amount_paid" class="form-control" value="">
