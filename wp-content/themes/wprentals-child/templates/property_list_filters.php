...
if( is_tax() ){
    ...
    $category_second_action_dropdown        =  stripslashes( esc_html(get_option('wp_estate_category_second_dropdown', '')));
    ...
    $category_second_dropdown_label         =   stripslashes( esc_html(get_option('wp_estate_category_main_dropdown', '')));
...
$listing_filter_array   = array(
                            "7"=>esc_html__( 'Name A to Z','wprentals'),
                            "8"=>esc_html__( 'Name Z to A','wprentals'),
...
?>
    ...
    <div class="listing_filters_head row"> 
        ...
        <!--
			...
			-->
            <div class="col-md-4 main_taxonomy_filter">
                <div class="dropdown form_control listing_filter_select" >
			...
			-->
            <div class="col-md-4 area_taxonomy_filter">
                <div class="dropdown form_control listing_filter_select" >
