...
$adv_search_back_hover_button          =  esc_html ( get_option('wp_estate_adv_search_back_hover_button ','') ); 
    if($adv_search_back_hover_button !=''){
        print'#advanced_submit_widget:hover, #advanced_submit_2_mobile:hover, #advanced_submit_2:hover, #advanced_submit_3:hover,#advanced_submit_shorcode:hover,.adv_handler:hover,#advanced_submit_4:hover{
               background:#'.$adv_search_back_hover_button .'!important;
            }';
    }
