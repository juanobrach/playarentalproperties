...
register_post_type( 'wpestate_booking',
		array(
			'labels' => array(
                'name'          => esc_html__(  'Bookings','wprentals'),
                'singular_name' => esc_html__(  'Booking','wprentals'),
                'add_new'       => esc_html__( 'Add New Booking','wprentals'),
                'add_new_item'          =>  esc_html__( 'Add booking','wprentals'),
                'edit'                  =>  esc_html__( 'Edit' ,'wprentals'),
                'edit_item'             =>  esc_html__( 'Edit booking','wprentals'),
                'new_item'              =>  esc_html__( 'New booking','wprentals'),
                'view'                  =>  esc_html__( 'View','wprentals'),
                'view_item'             =>  esc_html__( 'View booking','wprentals'),
                'search_items'          =>  esc_html__( 'Search booking','wprentals'),
                'not_found'             =>  esc_html__( 'No bookings found','wprentals'),
                'not_found_in_trash'    =>  esc_html__( 'No bookings found','wprentals'),
                'parent'                =>  esc_html__( 'Parent booking','wprentals')
			),
		'public' => true,
		'has_archive' => true,
...
if( !function_exists('wpestate_my_booking_columns') ):
    function wpestate_my_booking_columns( $columns ) {
        ...
        $columns['booking_estate_status']   = esc_html__( 'Status','wprentals');
        $columns['booking_estate_period']   = esc_html__( 'Period','wprentals');
        $columns['booking_estate_listing']  = esc_html__( 'Listing','wprentals');
        $columns['booking_estate_owner']    = esc_html__( 'Owner','wprentals');
        $columns['booking_estate_renter']   = esc_html__( 'Renter','wprentals');
        $columns['booking_estate_value']   = esc_html__( 'Value','wprentals');
        $columns['booking_estate_value_to_be_paid']   = esc_html__( 'Initial Deposit','wprentals');
...
if( !function_exists('wpestate_populate_booking_columns') ):
    function wpestate_populate_booking_columns( $column ) {
        ...
        if(  'booking_estate_period' == $column){
            echo esc_html__( 'from','wprentals').' '.esc_html(get_post_meta($the_id, 'booking_from_date', true)).' '.esc_html__( 'to','wprentals').' '. esc_html(get_post_meta($the_id, 'booking_to_date', true));
        }
...
function wpestate_payments_management(){
    ...
    print'
        <div class="col-md-1 payment_management_head">
            '.esc_html__('Booking No','wprentals').'
        </div>
         <div class="col-md-1 payment_management_head">
            '.esc_html__('Status','wprentals').'
        </div>
        ...
        <div class="col-md-1 payment_management_head">
            '.esc_html__('Total Price','wprentals').'
        </div>

        <div class="col-md-1 payment_management_head">
            '.esc_html__('To Be Paid','wprentals').'
        </div>

        <div class="col-md-1 payment_management_head">
            '.esc_html__('Security Deposit','wprentals').'
        </div>

        <div class="col-md-1 payment_management_head">
            '.esc_html__('Balance Invoice ID','wprentals').'
        </div>';
