...
function wpestate_add_welcome_widget(){
    ...
    print '<a class="wpestate_admin_button reverse_but" href="'.get_bloginfo('url').'/wp-admin/admin.php?page=libs%2Ftheme-admin.php&subpage=logos_favicon_tab" style="float:right;">'.__('Upload New Logo','wprentals').'</a>';
    ...
    print '<div class=" widget_content_wrapper" >';
        ...
        $font_color                     =   esc_html( get_option('wp_estate_content_font_color', '') );
        ...
        print '<a class="wpestate_admin_button reverse_but" href="'.get_bloginfo('url').'/wp-admin/admin.php?page=libs%2Ftheme-admin.php&subpage=custom_colors_tab">'.__('Change Colors','wprentals').'</a>';
    print '</div>'; 
}
...
function wpestate_add_new_page_widget(){
    ...
    print '<form action = "" method="post">';
        ...
        print '<div class="see_pages_dash"><a href="'.get_bloginfo('url').'/wp-admin/edit.php?post_type=page">'.__('See All Your Pages','wprentals').'</a></div>';
        print ' <div class="">
...
function wpestate_add_payments_widget(){
    ...
    print '<a class="wpestate_admin_button reverse_but" style="margin-top:70px;" href="/wp-admin/admin.php?page=libs%2Ftheme-admin.php&subpage=pay_settings">'.__('Edit Payment Details','wprentals').'</a>';
