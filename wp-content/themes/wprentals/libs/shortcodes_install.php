...
if( function_exists('vc_map') ):
    ...
    array(
       ...
       "base" => "featured_place",
       "class" => "",
       "category" => esc_html__( 'Content','wprentals'),
       'admin_enqueue_js' => array(get_template_directory_uri().'/vc_extend/bartag.js'),
       'admin_enqueue_css' => array(get_template_directory_uri().'/vc_extend/bartag.css'),
       'weight'=>100,
       'icon'   =>'wpestate_vc_logo',
       'description'=>esc_html__( 'Featured Category Shortcode','wprentals'),
       "params" => array(
            array(
                "type" => "autocomplete",
                "holder" => "div",
    ...
    vc_map( array(
        ...
        'weight'=>100,
        'icon'   =>'wpestate_vc_logo',
        'description'=>esc_html__( 'Categories List','wprentals'),  
        "params" => array(
            array(
                "type" => "autocomplete",
                "holder" => "div",
    ...
    array(
       ...
       'weight'=>100,
       'icon'   =>'wpestate_vc_logo',
       'description'=>esc_html__( 'Recent Items Slider Shortcode','wprentals'),
       "params" => array(
           array(
             "type" => "textfield",
             "holder" => "div",
    ...
    $icon_position  =array('left','central');
      vc_map( array(
       ...
       'weight'=>100,
        'icon'   =>'wpestate_vc_logo',
        'description'=>esc_html__( 'Icon Content Box Shortcode','wprentals'),  
       "params" => array(
          array(
             "type" => "textfield",
             "holder" => "div",
    ...
    $spacer_type                    = array(1,2);
      vc_map(
           ...
           'weight'=>102,
            'icon'   =>'wpestate_vc_logo',
            'description'=>esc_html__( 'Spacer Shortcode','wprentals'),
           "params" => array(
               array(
                 "type" => "dropdown",
                 "holder" => "div",
    ...
    vc_map( array(
       ...
       'weight'=>100,
        'icon'   =>'wpestate_vc_logo',
        'description'=>esc_html__( 'List Items by ID Shortcode','wprentals'),
       "params" => array(
            array(
             "type" => "textfield",
             "holder" => "div",
    ...
    vc_map(
           array(
           "name" => esc_html__( "Testimonial",'wprentals'),
           "base" => "testimonial",
           "class" => "",
           "category" => esc_html__( 'Content','wprentals'),
           'admin_enqueue_js' => array(get_template_directory_uri().'/vc_extend/bartag.js'),
           ...
           'weight'=>102,
           'icon'   =>'wpestate_vc_logo',
           'description'=>esc_html__( 'Testiomonial Shortcode','wprentals'),
           "params" => array(
              array(
                 "type" => "textfield",
                 "holder" => "div",
    ...
    array(
       ...
       'weight'=>100,
       'icon'   =>'wpestate_vc_logo',
       'description'=>esc_html__( 'Recent Items Shortcode','wprentals'),
       "params" => array(
            array(
                "type" => "dropdown",
                "holder" => "div",
    ...
    array(
       ...
       'weight'=>100,
       'icon'   =>'wpestate_vc_logo',
       'description'=>esc_html__( 'Featured Owner Shortcode','wprentals'),
       "params" => array(
          array(
             "type" => "textfield",
             "holder" => "div",
    ...
    vc_map(
       ...
       'weight'=>100,
       'icon'   =>'wpestate_vc_logo',
       'description'=>esc_html__( 'Featured Article Shortcode','wprentals'),
       "params" => array(
            array(
               "type" => "textfield",
               "holder" => "div",
    ...
    array(
       ...
       'weight'=>100,
       'icon'   =>'wpestate_vc_logo',
       'description'=>esc_html__( 'Featured Listing Shortcode','wprentals'),
       "params" => array(
            array(
               "type" => "textfield",
               "holder" => "div",
    ...
    vc_map(array(
       ...
       'weight'=>100,
       'icon'   =>'wpestate_vc_logo',
       'description'=>esc_html__( 'Login Form Shortcode','wprentals'),  
       "params" => array( array(
             "type" => "textfield",
             "holder" => "div",
             "class" => "",
    ...
    vc_map(
     array(
       ...
       'weight'=>100,
       'icon'   =>'wpestate_vc_logo',
       'description'=>esc_html__( 'Register Form Shortcode','wprentals'),    
       "params" => array()
    )
    ...
    vc_map(
       ...
       'weight'=>100,
       'icon'   =>'wpestate_vc_logo',
       'description'=>esc_html__( 'Advanced Search Shortcode','wprentals'),     
       "params" => array(
           array(
             "type" => "textfield",
             "holder" => "div",
     ...
     vc_map(array(
        ...
        'weight' => 100,
        'icon' => 'wpestate_vc_logo',
        'description' => esc_html__('Categories Slider Shortcode', 'wprentals'),
        "params" => array(
            array(
                "type" => "autocomplete",
                "holder" => "div",
