...
if( !function_exists('estate_listing_price') ):
    function estate_listing_price($post_id){
        ...
        if($price_per_guest_from_one!=1){
            ...
            if ($property_price != 0){
                $return_string.='<div class="listing_detail list_detail_prop_price_per_night col-md-6"><span class="item_head">'.wpestate_show_labels('price_label',$rental_type).':</span> ' .$property_price_before_label.' '. $property_price_show.' '.$property_price_after_label. '</div>'; 
            }

            if ($property_price_per_week != 0){
                $return_string.='<div class="listing_detail list_detail_prop_price_per_night_7d col-md-6"><span class="item_head">'.wpestate_show_labels('price_week_label',$rental_type).':</span> ' . $property_price_per_week_show . '</div>'; 
            }

            if ($property_price_per_month != 0){
                $return_string.='<div class="listing_detail list_detail_prop_price_per_night_30d col-md-6"><span class="item_head">'.wpestate_show_labels('price_month_label',$rental_type).':</span> ' . $property_price_per_month_show . '</div>'; 
            }
        ...
        if ($min_days_booking!=0){
            $return_string.='<div class="listing_detail list_detail_prop_price_min_nights col-md-6"><span class="item_head">'.esc_html__( 'Minimum no of','wprentals').' '.wpestate_show_labels('nights',$rental_type).':</span> ' . $min_days_booking . '</div>'; 
        }
    ...
    function wpestate_show_custom_details($edit_id,$is_dash=0){
        ...
        if(is_array($mega)){
            ...
            <div class="custom_day custom_day_header"> 
                ...
                if($price_per_guest_from_one!=1){
                    print'
                    <div class="custom_price_per_day">'.wpestate_show_labels('price_label',$rental_type).'</div>    
                    <div class="custom_price_per_day">'.wpestate_show_labels('price_week_label',$rental_type).'</div>  
                    <div class="custom_price_per_day">'.wpestate_show_labels('price_month_label',$rental_type).'</div>  
                    <div class="custom_day_min_days">'.esc_html__('Minimum Booking days','wprentals').'</div>   
                        ...
                        if($flag==1){
                         ...
                         //   $to_date->modify('yesterday');
                            ...
                            if($price_per_guest_from_one!=1){
                                ...
                                print'
                                <div class="custom_day_min_days">';
                                print '<div class="custom_price_label">'.esc_html__('Minimum Booking days','wprentals').'</div>';
                                if( $flag_min_days!=0 ){
                                    print $flag_min_days;
                                }else{
                                    echo '-';
