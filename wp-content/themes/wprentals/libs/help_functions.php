...
function wpestate_extra_options_exp($extra_id){
    ...
    if($rental_type==1){
        $options_array=array(
            ...
            2   =>  esc_html__('Per Guest','wprentals'),
            3   =>  esc_html__('Per Day per Guest','wprentals')
        );
    }
...
//                  <div data-toggle="dropdown" id="adv_actions_mobile" class="filter_menu_trigger" data-value="all">'.esc_html__( 'All Sizes','wprentals').'<span class="caret caret_filter"></span> </div>           
...
//                  $return_string='
//                  <div class="dropdown form-control">
//                  <div data-toggle="dropdown" id="adv_categ_mobile" class="filter_menu_trigger" data-value="all">'.esc_html__( 'All Types','wprentals').' <span class="caret caret_filter"></span> </div>           
...
//                    $return_string='
//                    <div class="dropdown form-control">
//                        <div data-toggle="dropdown" id="advanced_city_mobile" class="filter_menu_trigger" data-value="all">'. esc_html__( 'All Cities','wprentals').' <span class="caret caret_filter"></span> </div>           
...
//                    $return_string='
//                    <div class="dropdown form-control">
//                        <div data-toggle="dropdown" id="advanced_area_mobile" class="filter_menu_trigger" data-value="all">'.esc_html__( 'All Areas','wprentals').'<span class="caret caret_filter"></span> </div>           
...
//                            .esc_html__( 'All Sizes','wprentals').'<span class="caret caret_filter"></span>
//                        </div>           
//                        <input type="hidden" name="filter_search_action[]" value="">
//
...
//                        .esc_html__( 'All Types','wprentals').' <span class="caret caret_filter"></span>
//                        </div>           
//                        <input type="hidden" name="filter_search_type[]" value="">
//
...
//                            . esc_html__( 'All Cities','wprentals').' <span class="caret caret_filter"></span>
//                        </div>           
//                        <input type="hidden" name="advanced_city" value="">
...
//                            .esc_html__( 'All Areas','wprentals').'<span class="caret caret_filter"></span>
//                        </div>           
//                        <input type="hidden" name="advanced_area" value="">
                ...
                foreach($advanced_exteded as $checker => $value){
                   ...
                   $input_name     =   sanitize_key($input_name);
                    ...
                    if($value!='none'){
                        ...
                        print 'value="1" ><label for="'.$input_name.$tip.'">'.stripslashes($value). '</label></div>';
                    }
                }
...
function wpestate_convert_dateformat($date){
    ...
    $format = get_option('wp_estate_date_format','');
    ...
    switch ($dates_types[$format]) {
        case 'yy-mm-dd':
            list($yy,$mm,$dd) = explode('-',$date);
            break;
        case 'yy-dd-mm':
            list($yy,$dd,$mm) = explode('-',$date);
            break;
        case 'dd-mm-yy':
        ...
        case 'mm-dd-yy':
            ...
            break;
        case 'dd-yy-mm':
            list($dd,$yy,$mm) = explode('-',$date);
            break;
        case  'mm-yy-dd':
            list($mm,$yy,$dd) = explode('-',$date);
            break;
        default:
            break;
    }
...
function wpestate_return_all_fields($is_mandatory=0){
    ...
    if( !empty($custom_fields)){  
        while($i< count($custom_fields) ){
            ...
            $slug   =   sanitize_key($slug);
            $all_submission_fields[strtolower($slug)]=$label;
            $i++;
       }
    }
...
function wpestate_show_labels($label,$type){
    $labels = array(
        'check_in'  =>array(
...
function wpestate_show_tax_header(){
	...
	if($term_data->name == "Villas" || $term_data->name == "Condos") {
    print '<h1 class="entry-title entry-tax">'.$term_data->name.' for rent in Playa del Carmen</h1>';
	}
	else {
		print '<h1 class="entry-title entry-tax">Vacation Rentals in '.$term_data->name.'</h1>';
	}
...
function wpestate_font_awesome_list(){
    ...
    print '<input type="text" id="icon_look_for" value="" placeholder="'.esc_html__('Type to Search','wprentals').'">';
