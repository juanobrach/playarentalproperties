	...
	function widget($args, $instance){
		...
		if($title) {
                ...
                if($search_type == 'oldtype' || $search_type=='newtype'){ 
                    ...
                    print '
                    <div class="map_icon">';
                        print  wpestate_search_location_field(esc_html__('Where do you want to go ?','wprentals'),'sidebar');
                    print '</div>

                    <div class="has_calendar calendar_icon ">
                        <input type="text" id="check_in_widget" class="form-control " name="check_in" placeholder="'.esc_html__( 'Check in','wprentals').'">       
                    </div>

                    <div class="has_calendar calendar_icon ">
                        <input type="text" id="check_out_widget" disabled class="form-control " name="check_out" placeholder="'.esc_html__( 'Check Out','wprentals').'">
                    </div>

                    <div class="dropdown form-control guest_form">
                        <div data-toggle="dropdown" id="guest_no_widget" class="filter_menu_trigger" data-value="all"> '.esc_html__( 'Guests','wprentals').' <span class="caret caret_filter"></span> </div>           
                ...
                print'<button class="wpb_btn-info wpb_regularsize wpestate_vc_button  vc_button" id="advanced_submit_widget">'.esc_html__( 'Search','wprentals').'</button>
		...
		print $after_widget;
         ...
         function normal_fields_widget($action_select_list,$cate_select_list,$select_city_list,$select_area_list){
                      ...
                      if( !empty($select_city_list) ){
                        print'
                             <div class=" dropdown form-control" >
                                <div data-toggle="dropdown" id="sidebar_filter_cities" class="sidebar_filter_menu"> '. esc_html__( 'All Cities','wprentals').' <span class="caret caret_sidebar"></span> </div>           
                      ...
                      if( !empty($select_area_list) ){
                        print'
                            <div class="dropdown form-control" >
                                <div data-toggle="dropdown" id="sidebar_filter_areas" class="sidebar_filter_menu">'. esc_html__( 'All Areas','wprentals').'<span class="caret caret_sidebar"></span> </div>           
                    ...
                    print'    
                    <input type="text" id="adv_rooms_widget" name="advanced_rooms" placeholder="'.esc_html__( 'Type Bedrooms No.','wprentals').'"      class="advanced_select form-control">
                    <input type="text" id="adv_bath_widget"  name="advanced_bath"  placeholder="'.esc_html__( 'Type Bathrooms No.','wprentals').'"  class="advanced_select form-control">';
