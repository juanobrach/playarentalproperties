                ...
                print '
                   ...
                   //     print '<div id="print_invoice" data-invoice_id="'.$invoice_id.'" ><i class="fas fa-print" aria-hidden="true" ></i></div>';
                       ...
                       <div class="invoice_data">
                            ...
                            <span class="date_duration"><span class="invoice_data_legend">'.esc_html__( 'No of nights','wprentals').': </span>'.$booking_array['numberDays'].'</span>
                            ...
                            if($booking_array['price_per_guest_from_one']==1){
                                ...
                                print '<span class="date_duration"><span class="invoice_data_legend">'.esc_html__( 'Price per night','wprentals').': </span>';
                            ...
                            print'<div class="invoice_row invoice_content">
                                    ...
                                    <span class="inv_exp">';
                                        ...
                                        if(trim($detail[0])==esc_html__( 'Extra Guests','wprentals')){ 
                                            print $booking_array['numberDays'].' '.esc_html__( 'nights','wprentals').' x '.$booking_array['extra_guests'].' '.esc_html__('extra guests','wprentals');
                    ...
                    if($is_full!=1){
                        if( $balance>0 ){
                            ...
                            print '<div class="invoice_pay_status_note">'.__('You will need to pay the remain balance until the first day of your period!','wprentals').'</div>';
            ...
            <div class="create_invoice_form">
                ...
                <div class="invoice_table">
                    <div class="invoice_data">
                        ...
                        <span class="date_interval"><span class="invoice_data_legend">'.esc_html__( 'Period','wprentals').' : </span>'.wpestate_convert_dateformat_reverse($booking_from_date).' '.esc_html__( 'to','wprentals').' '.wpestate_convert_dateformat_reverse($booking_to_date).'</span>
                        <span class="date_duration"><span class="invoice_data_legend">'.esc_html__( 'No of nights','wprentals').': </span>'.$booking_array['count_days'].'</span>
                        ...
                        if($booking_array['price_per_guest_from_one']==1){
                            ...
                            print'    
                            <span class="date_duration"><span class="invoice_data_legend">'.esc_html__( 'Price per night','wprentals').': </span>';
                        ...
                        <div class="invoice_row invoice_content">
                            ...
                            if($booking_array['price_per_guest_from_one']==1){
                                ...
                                if($booking_array['numberDays']==1){
                                    print ' <span class="inv_exp">   ('.$booking_array['numberDays'].' '.esc_html__( 'night','wprentals').' | '.$new_price_to_show.') </span>';
                                }else{
                                    print ' <span class="inv_exp">   ('.$booking_array['numberDays'].' '.esc_html__( 'nights','wprentals').' | '.$new_price_to_show.') </span>';
                                }
                            }
                            ...
                            if($booking_array['has_guest_overload']!=0 && $booking_array['total_extra_price_per_guest']!=0){
                                ...
                                <div class="invoice_row invoice_content">
                                    ...
                                    <span class="inv_exp">   ('.$booking_array['numberDays'].' '.esc_html__( 'nights','wprentals').' | '.$booking_array['extra_guests'].' '.esc_html__('extra guests','wprentals').' )';
        ...
        <div class="show_cost_form" id="show_cost_form" >
            <div class="cost_row">
                ...
                if($booking_array['price_per_guest_from_one']==1){
                    ...
                    print $booking_array['count_days'].' '.wpestate_show_labels('nights',$rental_type).' x '.$booking_array['curent_guest_no'].' '.esc_html__( 'guests','wprentals');
                    ...
                    if( $booking_array['has_custom'] == 1 ){
                        print  $booking_array['numberDays'].' '.wpestate_show_labels('nights_custom_price',$rental_type);
                    }else if( $booking_array['has_wkend_price']===1 && $booking_array['cover_weekend']===1) {
                        print  $booking_array['numberDays'].' '.wpestate_show_labels('days_custom_price',$rental_type);
                    }else{
                        print  $price_show.' x '.$booking_array['numberDays'].' '.wpestate_show_labels('nights',$rental_type);
                    }
