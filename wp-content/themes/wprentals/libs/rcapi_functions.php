...
function rentals_api_managment(){
    ...
    if( rcapi_check_api_status()=='true' ){
        print '<div class="apinotice">'.esc_html__('You are now connected to RentalsClub API!','wprentals').'</div>';
     
    }else{
        print '<div class="apinotice apierror">'.esc_html__('Failed connection to RentalsClub.org Api! Please check your user credentials and api keys!','wprentals').'</div>';

         
    }
    
    print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Rentals Club API Key','wprentals').'</div>
        <div class="option_row_explain">'.__('Rentals Club API Key','wprentals').'</div>    
            <input type="text" name="rcapi_api_key" id="rcapi_api_key" value="'.$rcapi_api_key.'"/>
    </div>';

    print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Rentals Club API Secret Key','wprentals').'</div>
        <div class="option_row_explain">'.__('Rentals Club  API Secret Key','wprentals').'</div>    
    ...
    print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Rentals Club Username','wprentals').'</div>
        <div class="option_row_explain">'.__('Rentals Club Username','wprentals').'</div>    
            <input type="text"  name="rcapi_api_username" id="rcapi_api_secret_key" value="'.$rcapi_api_username.'"/>
    </div>';
    
    print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Rentals Club Password','wprentals').'</div>
        <div class="option_row_explain">'.__('Rentals Club password','wprentals').'</div>    
