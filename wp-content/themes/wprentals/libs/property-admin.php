...
if( !function_exists('wpestate_display_features') ):
    ...
    print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Add New Element in Features and Amenities','wprentals').'</div>
        <div class="option_row_explain">'.__('Type and add a new item in features and amenities list.','wprentals').'</div>    
    ...
    print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Features and Amenities list','wprentals').'</div>
        <div class="option_row_explain">'.__('list of already added features and amenities','wprentals').'</div>    
            <textarea id="feature_list" name="feature_list" rows="15" cols="42">'. $feature_list.'</textarea> 
        </div>';

     print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Show the Features and Amenities that are not available','wprentals').'</div>
        <div class="option_row_explain">'.__('Show on property page the features and amenities that are not selected?','wprentals').'</div>    
