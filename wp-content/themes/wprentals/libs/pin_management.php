       ...
       if ( $city_tax && ! is_wp_error( $city_tax ) ) { 
        ...
        //add area
         if ( $area_tax && ! is_wp_error( $area_tax ) ) { 
            ...
            if( get_option('wp_estate_custom_icons_infobox','')==='yes'){
                $place_markers[]  = wpestate_custom_infobox_values( get_option( 'wp_estate_custom_infobox_fields', true),$city,$area,$the_id); 
            }
