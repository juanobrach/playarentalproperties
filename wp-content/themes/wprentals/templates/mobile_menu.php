        ...
        if ( 0 != $current_user->ID  && is_user_logged_in() ) {
            ...
            <ul class="user_mobile_menu_list">
                ...
                <?php if( wpestate_check_user_level() ) { ?>
                    <li><a href="<?php print $dash_link;?>" ><i class="fas fa-map-marker"></i><?php esc_html_e('My Listings','wprentals');?></a></li>
                    <li><a href="<?php print $add_link;?>" ><i class="fas fa-plus"></i><?php esc_html_e('Add New Listing','wprentals');?></a></li> 
                <?php } ?>
