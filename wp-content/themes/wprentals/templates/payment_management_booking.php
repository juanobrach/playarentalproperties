...
<div class="col-md-2">
    <?php print $booking_from_date.' - '.$booking_to_date; ?>
</div>

<div class="col-md-1">
    <?php print $booking_guests;?>
</div>
 
<div class="col-md-1">
    <?php print $invoice_no;?>
</div>
...
<div class="col-md-1">
    <?php print $to_be_paid;?>
</div>

<div class="col-md-1">
    <?php print $security_deposit;?>
</div>

<div class="col-md-1">
    <?php print $full_pay_invoice_id;?>
</div>
...
<div class="col-md-12 actions_row">
    ...
    <?php
       print 'service fee'.$service_fee.' taxes: '.$booking_taxes.' youearned'.$youearned;
        ...
        if( time() < $unix_start_book ){
             print '  <span class="pay_owner">'. esc_html__('Pay Owner- Disabled until ','wprentals').$booking_from_date.'</span>';
        }else{
    ...
    <?php
        ...
        if( time() < ( $unix_start_book+7*24*60*60 ) ){
            print '  <span class="refund_buyer">'. esc_html__('Refund Security Deposit- Disabled until ','wprentals').$booking_to_date.'</span>';
        }else{
