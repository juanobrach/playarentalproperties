    ...
    <div class="row">
        ...
        if(is_array($submission_page_fields) && 
            ...
            <div class="col-md-12">
               ...
               <div class="col-md-3">
                   <p>            
                        <label for="property_latitude"><?php esc_html_e('Latitude (for Google Maps Pin Position)','wprentals'); ?></label>
               ...
               <div class="col-md-3">
                   <p>    
                       <label for="property_longitude"><?php esc_html_e('Longitude (for Google Maps Pin Position)','wprentals');?></label>
