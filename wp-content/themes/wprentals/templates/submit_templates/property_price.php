...
<div class="col-md-12">
        ...
        <div class="row">       
           <div class="col-md-3 dashboard_chapter_label">
                ...
                if($item_rental_type==0){
                    esc_html_e('Price per night in ','wprentals');
                }else{
                    esc_html_e('Price per day in ','wprentals');
                }
            ;print $wp_estate_currency_symbol.' '; esc_html_e('(daily price,only numbers)','wprentals'); ?>  </label>
            </div>
            <div class="col-md-3">    
                <label  class="label_adjust" for="property_price"> 
                    <?php 
                    if($item_rental_type==0){
                        esc_html_e('Price per night','wprentals'); 
                    }else{
                        esc_html_e('Price per day','wprentals'); 
                    }
                    ?>  
                </label>
    ...
    ?>
        ...
        <div class="row">
            <div class="col-md-3 dashboard_chapter_label">
                <label for="property_taxes"> <?php esc_html_e('Taxes in % (taxes are considered included in the daily price) ','wprentals'); ?>  </label>
            </div>
            <div class="col-md-3">
    ...
    <div class="row">
        <div class="col-md-3 dashboard_chapter_label">
            <label for="property_price_per_week"> 
                <?php
                if($item_rental_type==0){
                    esc_html_e('Price per night if the item is rented for more than 1 week (7 nights) or more than 1 month (30 nights)','wprentals'); 
                }else{
                    esc_html_e('Price per day if the item is rented for more than 1 week (7 days) or more than 1 month (30 days)','wprentals'); 
                }
                ?>  
            </label>
        </div>
        ...
        ?>
            <div class="col-md-3"> 
                <label for="property_price_per_week"> 
                    <?php 
                    if($item_rental_type==0){
                        esc_html_e('Price per night for more than 7 days','wprentals'); 
                    }else{
                        esc_html_e('Price per day for more than 7 days','wprentals'); 
                    }
                    ?>
                </label>
        ...
        ?>
            <div class="col-md-3">
                <label for="property_price_per_month"> 
                    <?php  
                    if($item_rental_type==0){ 
                        esc_html_e('Price per night for more than 30 days','wprentals');
                    }else{
                        esc_html_e('Price per day for more than 30 days','wprentals');
                    } 
                    ?>  
                 </label>
    ...
    ?>
        <div class="row">
            <div class="col-md-3 dashboard_chapter_label">
                <label for=""> <?php 
                if($item_rental_type==0){ 
                    esc_html_e('Early Bird Discount - in % from the price per night','wprentals');
                }else{
                      esc_html_e('Early Bird Discount - in % from the price per day','wprentals');
                }
            ?>  </label>
            </div>
            <div class="col-md-3">
    ...
    ?>
        <div class="row">
            ...
            <div class="col-md-3"> 
                <label for="extra_price_per_guest"> <?php esc_html_e('Extra Price per guest per night in ','wprentals');print $wp_estate_currency_symbol.' ';  ?>  </label>
                ...
                <label>
                    <?php
                        if(is_array($submission_page_fields) &&      ( in_array('checkin_change_over', $submission_page_fields) &&        in_array('checkin_checkout_change_over', $submission_page_fields) ) ) {
                            esc_html_e('These options do not work together - choose only one and leave the other one on "All"','wprentals');
                        }else{
