...
<div class="col-md-4"> 
    <div class="user_dashboard_panel pack_unit_list">
        ...
        <div class="pack-listing-period">
            <?php esc_html_e('Time Period: ','wprentals'); print $billing_freq.' '. wpestate_show_bill_period($biling_period); ?>
        </div>
        ...
        if($unlimited_listings==1){
            ...
            print'<div class="pack-listing-period">'.$pack_list.' '.esc_html__( 'Listings','wprentals').' </div>';    
        }
        ?>

    <div class="pack-listing-period">
        <?php print $pack_featured.' '.esc_html__( 'Featured','wprentals');?> 
    </div> 
    </div>
</div>